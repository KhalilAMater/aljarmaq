    ...
    darkMode: function () {
        ...
        if (e.isVariableDefined(dark)) {
          ...
          var changeThemeToDark = () => {
            ...
            if(dir == 'rtl') {
                style.setAttribute('href', $('html').attr('data-url')+'assets/home/assets/css/style-dark-rtl.css');
            } else {
                style.setAttribute('href', $('html').attr('data-url')+'assets/home/assets/css/style-dark.css');
            }
          ...
          var changeThemeToLight = () => {
            ...
            if(dir == 'rtl') {
                style.setAttribute('href', $('html').attr('data-url')+'assets/home/assets/css/style-rtl.css');
            } else {
                style.setAttribute('href', $('html').attr('data-url')+'assets/home/assets/css/style.css');
            }
